...
public abstract class MudFluid extends FlowableFluid {
    ...
    public Fluid getFlowing() {
        return ModFluids.MUD_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.MUD_STILL;
    }

    public Item getBucketItem() {
        return Moditems.MUD_BUCKET;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return Modblocks.MUD_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }

    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.MUD_STILL || fluid == ModFluids.MUD_FLOWING;
    }
